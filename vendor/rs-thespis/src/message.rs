//! Messaging infrastructure for actor communication in Thespis.
//!
//! This module provides the constructs necessary for handling messages within Thespis,
    ...
    R: Reply + ?Sized,
{
    ...
    /// use thespis::reply::DelegatedReply;
    ///
