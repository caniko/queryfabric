...
fn valid_bundle_fixture_verifies_against_its_staged_artifact() {
    ...
    assert_eq!(digest, "blake3-256:4d5083d6acdd6e3fe053c21b380cfa579b751a60565a1dfc37c056b64f32363c");
    ...
    let csv = b"id,reading,label\r\n00000000-0000-0000-0000-000000000001,1.5,ok\r\n";
    assert_eq!(tabular_schema_fingerprint(&schema), bundle.artifacts[0].schema_fingerprint);
