...
use queryfabric_ir::{
    ...
    BoundQueryPlan, BoundRelation, BoundSelect, BoundSetExpr, BoundTableWithJoins, FunctionRef,
    QueryDiagnostic, Result, SyntaxNode,
};
...
mod tests {
    use queryfabric_catalog::{
        BackendAdapter, Catalog, ColumnSchema, EmitArtifact, MemoryCatalog, RelationKind,
        RelationSchema, bind_and_validate,
    };
